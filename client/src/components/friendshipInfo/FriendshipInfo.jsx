...
function FriendshipInfo({ userId }) {
  ...
  async function getFriendshipInfo(userId) {
    try {
      ...
      console.log("Friendship Info:", info);
      ...
      case "pending":
        return initiatorId === user.userId ? (
          <button onClick={handleCancelRequest}>
            Cancel Request <i className="fa-solid fa-user-xmark"></i>
          </button>
        ) : (
          <>
            <button onClick={handleAcceptRequest}>
              Accept Request <i className="fa-solid fa-user-check"></i>
            </button>
            <button onClick={handleCancelRequest}>
              Decline Request <i className="fa-solid fa-user-large-slash"></i>
            </button>
          </>
        );
      default:
