...
function LoginForm(props) {
    ...
    console.log("if this appears indefinetly, we are in an infinite loop")
    ...
    return (
        <div className="login-form-container">
            <form className="login-form" onSubmit={handleSubmit}>
                ...
                <p className='signup-text'>Don't have an account? <span onClick={props.toggleShowSignup}>SignUp</span></p>
            </form>
        </div>
    );
};
